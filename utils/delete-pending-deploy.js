...
module.exports = function deletePendingDeploy(pendingDeployKey) {
    ...
    pendingDeploymentsInfo = pendingDeploymentsInfo.filter(pendingDeployment => pendingDeployment.key != pendingDeployKey);
